...
public class Files {
	public static void main(String[] args) throws IOException {
		...
		File fileObj1 = new File("E:\\Epita\\semester 3 - Java\\Newfile.txt");
		try {
		...
		FileWriter fWrite = new FileWriter("E:\\Epita\\semester 3 - Java\\Newfile.txt");
		...
		FileWriter file = new FileWriter("E:\\Epita\\semester 3 - Java\\Newfile.txt");
		String data = "";
		...
		try {
			...
			FileReader readFile = new FileReader("E:\\Epita\\semester 3 - Java\\Newfile.txt");
		...
		/*File filedelete = new File("E:\\Epita\\semester 3 - Java\\Newfile.txt");
